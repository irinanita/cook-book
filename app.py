...
'''
This will be used by those who want to install the project locally
on their machine. More details in the README file - Local Install Section
'''
...
def setup():
    ...
    if "units" not in collist:
        ...
        for unit in units_list:
            units_coll.insert_one({"unit_name": unit}) 

    flash('Everything is set up and ready to go. Have fun!')
